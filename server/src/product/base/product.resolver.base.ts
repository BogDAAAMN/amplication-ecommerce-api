...
import { FindManyProductArgs } from "./FindManyProductArgs";
import { FindOneProductArgs } from "./FindOneProductArgs";
import { Product } from "./Product";
import { FindManyCategoryArgs } from "../../category/base/FindManyCategoryArgs";
...
export class ProductResolverBase {
  ...
  async product(
    @graphql.Args() args: FindOneProductArgs,
    @gqlUserRoles.UserRoles() userRoles: string[]
