...
import { FindManyCategoryArgs } from "./FindManyCategoryArgs";
import { FindOneCategoryArgs } from "./FindOneCategoryArgs";
import { Category } from "./Category";
import { FindManyProductArgs } from "../../product/base/FindManyProductArgs";
...
export class CategoryResolverBase {
  ...
  async categories(
    @graphql.Args() args: FindManyCategoryArgs,
  ...
  async category(
    @graphql.Args() args: FindOneCategoryArgs,
    @gqlUserRoles.UserRoles() userRoles: string[]
  ...
  async products(
    ...
    @graphql.Args() args: FindManyProductArgs,
    @gqlUserRoles.UserRoles() userRoles: string[]
  ): Promise<Product[]> {
    const permission = this.rolesBuilder.permission({
      role: userRoles,
